...
The Golang SDK for the RealRest API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/real-rest-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/real-rest-sdk=../path/to/github.com/voxgig-sdk/real-rest-sdk
```
...
```
github.com/voxgig-sdk/real-rest-sdk/
...
The root package (`github.com/voxgig-sdk/real-rest-sdk`) re-exports everything needed
