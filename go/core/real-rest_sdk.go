...
func NewRealRestSDK(options map[string]any) *RealRestSDK {
	sdk := &RealRestSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *RealRestSDK) OptionsMap() map[string]any {
...
func (sdk *RealRestSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RealRestSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RealRestSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RealRestSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RealRestSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RealRestSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RealRestSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RealRestSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RealRestSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RealRestSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RealRestSDK {
	if sdkopts == nil {
