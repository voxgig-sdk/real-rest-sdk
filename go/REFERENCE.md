# RealRest Golang SDK Reference

Complete API reference for the RealRest Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *RealRestSDK`
...
#### `Object(data map[string]any) RealRestEntity`
...
```go
result, err := client.Object(nil).Update(map[string]any{
    "id": "object_id",
    // Fields to update
}, nil)
if err != nil {
...
```go
result, err := client.Object(nil).Remove(map[string]any{"id": "object_id"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
