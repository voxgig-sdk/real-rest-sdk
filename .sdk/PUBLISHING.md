...
|---|---|---|
| `ts/` | @voxgig-sdk/real-rest-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/real-rest-sdk \
      --repository voxgig-sdk/real-rest-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/real-rest-sdk` shows it, and
`npm trust revoke @voxgig-sdk/real-rest-sdk --id=<id>` removes it.
