...
class RealRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RealRestTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = RealRestTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = RealRestTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
