...
// RealRest SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RealRestOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RealRestOmni::structfix($now, Struct::undef()))
                        !== json_encode(RealRestOmni::structfix($val, Struct::undef()))) {
