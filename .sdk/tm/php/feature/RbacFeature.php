...
class RealRestRbacFeature extends RealRestBaseFeature
{
    ...
    private function _required(RealRestContext $ctx): ?string
    {
    ...
    private function _reject(RealRestContext $ctx, string $required): void
    {
    ...
    private function _track(RealRestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
