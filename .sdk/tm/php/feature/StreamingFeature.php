...
// RealRest SDK streaming feature
...
class RealRestStreamingFeature extends RealRestBaseFeature
{
    ...
    private function _iterate(RealRestResult $result): \Generator
    {
    ...
    private function _streamable(RealRestContext $ctx): bool
    {
