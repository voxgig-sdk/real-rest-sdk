...
class RealRestNetsimFeature extends RealRestBaseFeature
{
    ...
    private function _simulate(RealRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RealRestContext $ctx, array $applied): void
    {
        $client = $this->client;
