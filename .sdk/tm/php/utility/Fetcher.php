...
// RealRest SDK utility: fetcher

class RealRestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RealRestSDK/1.0)';
    ...
    public static function call(RealRestContext $ctx, string $fullurl, array $fetchdef): array
    {
