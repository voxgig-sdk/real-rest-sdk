...
class ObjectEntity extends RealRestEntityBase<ObjectType> {
  ...
  async update(this: any, reqdata?: ObjectUpdateData, ctrl?: Control): Promise<ObjectEntity> {
  ...
  async remove(
    this: any, reqmatch?: ObjectRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ObjectEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
