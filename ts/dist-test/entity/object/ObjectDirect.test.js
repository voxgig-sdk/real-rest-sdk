...
function liveScenariosActive() { return false && process.env.REAL_REST_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RealRestSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['REAL_REST_TEST_OBJECT_ENTID'];
    ...
    const client = new __1.RealRestSDK({
        base: 'http://localhost:8080',
