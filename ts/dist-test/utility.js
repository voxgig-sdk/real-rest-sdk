...
function envOverride(m) {
    if ('TRUE' === process.env.REAL_REST_TEST_LIVE ||
        'TRUE' === process.env.REAL_REST_TEST_OVERRIDE) {
    ...
    m.REAL_REST_TEST_EXPLAIN = process.env.REAL_REST_TEST_EXPLAIN || m.REAL_REST_TEST_EXPLAIN;
    return m;
}
