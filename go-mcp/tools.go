...
type Args struct {
	Entity string         `json:"entity" jsonschema:"object"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RealRestSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "real-rest_list",
		Description: "List records from RealRest. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "real-rest_load",
		Description: "Load a single record from RealRest. " +
...
func runOp(client *sdk.RealRestSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RealRestSDK, name string) (sdk.RealRestEntity, error) {
