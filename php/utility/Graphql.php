...
class RealRestGraphql
{
    ...
    // equivalent.
    public static function body(RealRestContext $ctx): mixed
    {
    ...
    public static function errors(RealRestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
