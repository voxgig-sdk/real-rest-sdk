...
// RealRest SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RealRestMakeRequest
{
    public static function call(RealRestContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RealRestResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RealRestResponse($fetched);
        } else {
