...
class RealRestTimeoutFeature extends RealRestBaseFeature
{
    ...
    private function _with_timeout(RealRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RealRestContext $_ctx, float $ms): void
    {
        $client = $this->client;
