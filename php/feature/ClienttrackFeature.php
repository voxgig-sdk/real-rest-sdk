...
// RealRest SDK clienttrack feature
...
class RealRestClienttrackFeature extends RealRestBaseFeature
{
    ...
    public function PostConstruct(RealRestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RealRest-SDK';
