...
class RealRestProxyFeature extends RealRestBaseFeature
{
    ...
    public function init(RealRestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RealRestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
