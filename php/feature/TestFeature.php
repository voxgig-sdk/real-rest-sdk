...
// RealRest SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RealRestTestFeature extends RealRestBaseFeature
{
    ...
    public function init(RealRestContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RealRestContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RealRestContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RealRestContext $ctx, $op, $args): array
    {
