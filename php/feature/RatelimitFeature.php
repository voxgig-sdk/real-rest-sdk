...
// RealRest SDK ratelimit feature
...
class RealRestRatelimitFeature extends RealRestBaseFeature
{
    ...
    private function _acquire(RealRestContext $ctx): void
    {
    ...
    private function _track(RealRestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
