...
class RealRestCacheFeature extends RealRestBaseFeature
{
    ...
    private function _through(RealRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
