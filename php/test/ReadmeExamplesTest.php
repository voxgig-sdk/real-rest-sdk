...
// RealRest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RealRestSDK::test)
...
{
    private const SDK_CLASS = 'RealRestSDK';
    ...
    private const SDK_BASE = 'realrest_sdk';
