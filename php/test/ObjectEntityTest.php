...
class ObjectEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REAL_REST_TEST_OBJECT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $object_ref01_resdata_up0 = Helpers::to_map(is_object($object_ref01_resdata_up0_result) && method_exists($object_ref01_resdata_up0_result, 'data_get') ? $object_ref01_resdata_up0_result->data_get() : $object_ref01_resdata_up0_result);
...
function object_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REAL_REST_TEST_OBJECT_ENTID");
