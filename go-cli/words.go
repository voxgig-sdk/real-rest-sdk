...
func registerSDKWords(r *eng.Registry, client *sdk.RealRestSDK) {
...
func runOp(client *sdk.RealRestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
