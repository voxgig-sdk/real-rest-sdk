...
from realrest_sdk.core.spec import RealRestSpec
from realrest_sdk.core.result import RealRestResult
from realrest_sdk.core.response import RealRestResponse
from realrest_sdk.core.operation import RealRestOperation
from realrest_sdk.core.error import RealRestError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = RealRestSDK.test(None, None)
        ...
        class TestInitFeature(RealRestBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RealRestBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RealRestSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RealRestSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RealRestSDK.test(None, setup_opts)
