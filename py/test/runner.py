...
class RealRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RealRestTestRunner.getenv("REAL_REST_TEST_LIVE")
        override = RealRestTestRunner.getenv("REAL_REST_TEST_OVERRIDE")
        ...
        explain = RealRestTestRunner.getenv("REAL_REST_TEST_EXPLAIN")
