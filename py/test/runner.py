...
class RealRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RealRestTestRunner.getenv("REALREST_TEST_LIVE")
        override = RealRestTestRunner.getenv("REALREST_TEST_OVERRIDE")
        ...
        explain = RealRestTestRunner.getenv("REALREST_TEST_EXPLAIN")
