# RealRest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RealRestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RealRestSDK(...) and RealRestSDK.test(...) become
#      RealRestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "realrest_sdk"
_SDK_CLASS = "RealRestSDK"
