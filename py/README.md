...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Object()` — each
...
```python
try:
    objects = client.Object().list({"id": "example_id"})
...
```
py/
├── realrest_sdk.py         -- Main SDK module
