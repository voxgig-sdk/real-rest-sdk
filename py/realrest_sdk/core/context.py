...
from realrest_sdk.core.control import RealRestControl
...
from realrest_sdk.core.helpers import get_ctx_prop, to_map
...
class RealRestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, RealRestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RealRestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RealRestError(code, msg, self)
