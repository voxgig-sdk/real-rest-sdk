...
from realrest_sdk.utility import register

# Load features
from realrest_sdk.feature.base_feature import RealRestBaseFeature
from realrest_sdk.features import _has_feature, _make_feature
...
class RealRestSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RealRestUtility()
        self._utility = utility

        from realrest_sdk.config import shared_config
    ...
    def get_utility(self):
        return RealRestUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RealRestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Object(self, data=None) -> "ObjectEntity":
        ...
        from realrest_sdk.entity.object_entity import ObjectEntity
